            ...
            <div className="space-y-6">
              ...
              <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <div className="text-2xl md:text-3xl text-muted-foreground mb-8 font-light">
                  ...
                  <span className="block text-xl md:text-2xl mt-2 text-primary">& Freelancer</span>
                </div>
              </div>
              
              <p className="text-lg text-muted-foreground max-w-xl mb-12 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="flex flex-col sm:flex-row gap-6 mb-12 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
                <Button size="lg" className="group bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 shadow-lg hover:shadow-xl transition-all duration-300">
                  <span>Explore My Work</span>
                </Button>
                <Button variant="outline" size="lg" className="border-2 hover-lift">
              ...
              <div className="flex gap-4 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
                {[
                  ...
                  <a
                    key={label}
                    href={href}
                    className={`p-4 rounded-xl glass-effect border hover:scale-110 transition-all duration-300 ${color} group`}
                    aria-label={label}
                  >
